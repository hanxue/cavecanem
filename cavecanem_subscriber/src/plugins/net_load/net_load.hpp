...
class netloadListener : public DDSDataReaderListener {
  public:
  netloadListener(std::string plugin_id);
  ~netloadListener(void);
...
private:
  ...
  netloadDataReader * netload_reader_;
  netloadListener *reader_listener_; 
