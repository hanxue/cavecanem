 ...
 */
__declspec(dllexport) memory::memory(string plugin_id, map<string,string> properties)
{
    // Customize if needed
 ...
 */
__declspec(dllexport) memory::~memory(void)
{
    // Customize if needed
    sigar_close(sig_);
 ...
 * @param properties Map of properties (will be empty in this plugin).
 */
__declspec(dllexport) bool memory::initialize_plugin(map<string,string> properties) 
{
    // Customize if needed
    sigar_open(&sig_);
...
/** 
 * @brief Gets some information related to the physical and swap memory and publishes it.
 * 
 * Gets some information related to the physical and swap memory 
 ...
 */
__declspec(dllexport) bool memory::generate_and_publish_information(DDSDynamicDataWriter *writer,
