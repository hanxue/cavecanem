 ...
 * @return 
 */
class proc_stat : public cc_plugin {
 public:
    __declspec(dllexport) proc_stat(std::string plugin_id,
		std::map<std::string,std::string> properties);
    __declspec(dllexport) virtual ~proc_stat();
 ...
 * @return 
 */
extern "C" __declspec(dllexport) cc_plugin* create_proc_stat(std::string plugin_id,
				 std::map<std::string,std::string> properties) {
